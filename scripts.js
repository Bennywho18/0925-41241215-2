...
const themes = {
    one: [
        { front: 'image/one1.png', back: 'image/one2.png' },
        { front: 'image/one1.png', back: 'image/one2.png' },
        { front: 'image/one1.png', back: 'image/one3.png' },
        { front: 'image/one1.png', back: 'image/one3.png' },
        { front: 'image/one1.png', back: 'image/one4.png' },
        { front: 'image/one1.png', back: 'image/one4.png' },
        { front: 'image/one1.png', back: 'image/one5.png' },
        { front: 'image/one1.png', back: 'image/one5.png' },
        { front: 'image/one1.png', back: 'image/one6.png' },
        { front: 'image/one1.png', back: 'image/one6.png' },
        { front: 'image/one1.png', back: 'image/one7.png' },
        { front: 'image/one1.png', back: 'image/one7.png' },
        { front: 'image/one1.png', back: 'image/one8.png' },
        { front: 'image/one1.png', back: 'image/one8.png' },
        { front: 'image/one1.png', back: 'image/one9.png' },
        { front: 'image/one1.png', back: 'image/one9.png' },
    ],
    history: [
        { front: 'image/history1.png', back: 'image/history2.png' },
        { front: 'image/history1.png', back: 'image/history2.png' },
        { front: 'image/history1.png', back: 'image/history3.png' },
        { front: 'image/history1.png', back: 'image/history3.png' },
        { front: 'image/history1.png', back: 'image/history4.png' },
        { front: 'image/history1.png', back: 'image/history4.png' },
        { front: 'image/history1.png', back: 'image/history5.png' },
        { front: 'image/history1.png', back: 'image/history5.png' },
        { front: 'image/history1.png', back: 'image/history6.png' },
        { front: 'image/history1.png', back: 'image/history6.png' },
        { front: 'image/history1.png', back: 'image/history7.png' },
        { front: 'image/history1.png', back: 'image/history7.png' },
        { front: 'image/history1.png', back: 'image/history8.png' },
        { front: 'image/history1.png', back: 'image/history8.png' },
        { front: 'image/history1.png', back: 'image/history9.png' },
        { front: 'image/history1.png', back: 'image/history9.png' },
    ]
};
